...
The pixel buffer can read OME-Zarr 0.4 or OME-Zarr 0.5 datasets
such as the ones generated by the
...
-   the scaling factor alongside the y and the x axes between all consecutive resolution
